	...
	modules: [
		...
		},
		{
			...
			config: {
				...
				type: "current",
				location: "Selong",
				locationID: "1627957", //ID from http://bulk.openweathermap.org/sample/city.list.json.gz; unzip the gz file and find your city
				apiKey: "247f78c9456c09b77280ae1e569d4a5a"
			}
		},
		{
			module: "weather",
		...
		},
		{
			...
			config: {
                		css: "2", // 1=default, 2=Black Boxes, 3=white Boxes, 4=Material, 5=Trending, 6=Neumorphism, 7=Glass, 8=iOS, 9=Jeans ,10=Green, 11=dark
           		}
		},
		{
			...
			config: {
				...
				updateInterval: 1000 * 10, // milliseconds
			}
		},
